...
public class RoundedUtil {
    ...
    public static void drawGradientCornerLR(
        ...
        Color mixedColor = interpolateColorC(topLeft, bottomRight, 0.5f);
    ...
    public static void drawGradientCornerRL(
        ...
        Color mixedColor = interpolateColorC(topRight, bottomLeft, 0.5f);
    ...
    public static void drawRound(float x, float y, float width, float height, float radius, boolean blur, Color color) {
        ...
        roundedShader.setUniformf("color", color.getRed() / 255f, color.getGreen() / 255f,
    ...
    private static void setupRoundedRectUniforms(
            float x, float y, float width, float height, float radius, ShaderUtil shader
    ) {
