...
public class CustomFog extends Module {
    ...
    public static NumberSetting startDistance = new NumberSetting("StartDistance", 0.0, 0, 20, 0.5);
    public static NumberSetting endDistance = new NumberSetting("EndDistance", 20, 1, 200, 1);
